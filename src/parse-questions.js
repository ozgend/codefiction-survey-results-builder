...
const getForm = async function (apiKey, formId) {
    let form;
    const file = `./assets/survey/form_${formId}.json`;
...
const mapFormFields = async function (apiKey, formId) {
    ...
    const file = `./assets/survey/mapped_questions_${formId}.json`;
